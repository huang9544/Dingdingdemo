...
public class GetAccessToken {
    ...
    public static void getAccessToken(String[] args_) throws Exception {
        java.util.List<String> args = java.util.Arrays.asList(args_);
        com.aliyun.dingtalkoauth2_1_0.Client client = GetAccessToken.createClient();
